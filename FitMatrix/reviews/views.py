...
def review_list(request):
    reviews = TrainerReview.objects.filter(user=request.user).select_related("trainer").order_by("-created_at")
...
def place_reviews_partial(request, slug):
    ...
    reviews = PlaceReview.objects.filter(place=place).order_by("-created_at")
