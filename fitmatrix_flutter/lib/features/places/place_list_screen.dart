        ...
        children: [
          ...
          _FilterCard(
            ...
            onPriceChanged: (value) =>
                ref.read(placeFiltersProvider.notifier).state = filters
                    .copyWith(price: value ?? ''),
            onSortChanged: (value) =>
                ref.read(placeFiltersProvider.notifier).state = filters
                    .copyWith(sort: value ?? ''),
          ...
          Expanded(
            child: places.when(
              ...
              error: (err, _) =>
                  Center(child: Text('Unable to load places: $err')),
        ...
        child: Column(
          children: [
            ...
            Align(
              ...
              child: MatrixButton(label: 'Refine', onPressed: onSubmit),
            ),
          ],
        ),
      ),
